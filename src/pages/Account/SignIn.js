    ...
    return (
        <div className="w-full py-4 flex flex-col justify-center">
            ...
            <section className="mt-16 flex justify-center text-primaryText">
                ...
                {activeStep === 1 && (
                    <StepTwoRegister setSuccessCode={setSuccessCode} handleNext={handleNext} email={email} />
                )}
                {activeStep === 2 && (
            ...
            <div className="mt-16 flex justify-between">
                {isFirstStep || isLastStep ? (
                    ...
                    <Button onClick={handlePrev} disabled={isFirstStep || isLastStep} className="bg-componentColor hover:bg-hover">
                        Back
                    </Button>
                )}
                {isLastStep ? (
